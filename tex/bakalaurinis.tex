...
ir skirtumus -- su \textquote{PCFG} metodo apmokytu modeliu parenkamas 
aukštesnis skaičius slaptažodžių, panašių į apmokymui naudotus slaptažodžius, o 
\textquote{PassGAN} -- su anksčiau nematytais slaptažodžiais. Svarbu paminėti, 
...
\textquote{PCFG} automated password guessing techniques have successfully 
...
\textquote{PassGAN} trained model performs better guessing passwords in 
