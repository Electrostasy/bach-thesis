...
\department{Išmaniųjų technologijų tyrimų grupė}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Testuojamas modelis su 20 \% \textquote{RockYou} duomenų rinkiniu.}
...
\end{figure}%
Palyginus šiuos rezultatus yra matyti, kad \textquote{PCFG} metodas ženkliai 
daugiau slaptažodžių parenka už \textquote{PassGAN} metodą -- maždaug 20-30 \% 
daugiau -- testuojant su 20 \% \textquote{RockYou} duomenų rinkinio testavimo 
aibe. Kitą vertus, \textquote{PassGAN} metodas parenka maždaug 16 \% daugiau 
slaptažodžių anksčiau nematytame \textquote{Linkedin} duomenų rinkinyje už 
\textquote{PCFG} metodą.
