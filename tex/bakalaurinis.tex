...
būdu (angl. \textquote{Brute Force}) per palyginti trumpą laiką.
Pavyzdžiui, su mano 9 metų senumo nešiojamuoju kompiuteriu, kuriame yra 
\textquote{Intel i5-2520M} procesorius, ir \textquote{Python} programine kalba 
...
\subsubsubsection{Tikimybinės, bekontekstes gramatikos}
...
prieinamos viešais šaltiniais -- \textquote{RockYou} ir \textquote{myspace}. 
...
\textquote{myspace} -- \ref{tab:myspace10} lentelėje.
...
\begin{table}[ht]
  ...
  \end{tabular}
  \caption{
    Duomenų rinkinio \textquote{myspace} 10 dažniausiai pasikartojančių 
    slaptažodžių
  }
  \label{tab:myspace10}
\end{table}
...
Šioje dalyje atliekami eksperimentai su \textquote{PassGAN} metodo 
realizacija\footnotemark, generuojant slaptažodžių sąrašus pagal 
\ref{sec:strategy} skyriuje aprašyta strategija.

\footnotetext{
  Realizacija yra paremta internetinėje svetainėje 
  \url{https://github.com/d4ichi/PassGAN} patalpinto projekto pagrindu.
}

\subsection{\textquote{PCFG} eksperimentų serija}
Šioje dalyje atliekami eksperimentai su \textquote{PCFG} metodo 
realizacija\footnotemark, generuojant slaptažodžių sąrašus pagal 
\ref{sec:strategy} skyriuje aprašyta strategija.

\footnotetext{
  Realizacija yra paremta internetinėje svetainėje 
  \url{https://github.com/lakiw/pcfg_cracker} patalpinto projekto pagrindu.
}
